...
KNOWN = {
    ...
    -16371: "setPurgeableState: (GPUTools)",
    ...
    -16199: "makeComputePipelineState(descriptor:options:reflection:)",
    ...
    -10188: "GPUTools.libraryUUIDTracking",
    -10186: "GPUTools.bufferCompleted",
    -10183: "GPUTools.libraryTracking",
}
